...
export default function Home() {
  ...
  const handleCariJadwalClick = (first: Station, dest: Station) => {
    const combinedData = `From: ${first.sta_name}, To: ${dest.sta_name}`;
  ...
  return (
    <>
      ...
      {/* Card Cari Kereta */}
      <CariJadwalCard onClick={handleCariJadwalClick} />
      {/* Menu */}
